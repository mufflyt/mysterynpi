...
- [`SURNAME_CREDENTIAL_COLLISIONS`](https://mufflyt.github.io/mysterynpi/reference/SURNAME_CREDENTIAL_COLLISIONS.md)
...
- [`nickname_dictionary_version()`](https://mufflyt.github.io/mysterynpi/reference/nickname_dictionary_version.md)
...
- [`taxonomy_consistent()`](https://mufflyt.github.io/mysterynpi/reference/taxonomy_consistent.md)
  : Is a record's taxonomy consistent with a board specialty?
  Three-valued.
...
## Nickname dictionary (deterministic table reads)
...
- [`npi_corroborate()`](https://mufflyt.github.io/mysterynpi/reference/npi_corroborate.md)
  : Corroborate candidate NPIs against a registry snapshot
- [`ORG_NOISE`](https://mufflyt.github.io/mysterynpi/reference/ORG_NOISE.md)
...
- [`MEDICAL_UNIT_PATTERNS`](https://mufflyt.github.io/mysterynpi/reference/MEDICAL_UNIT_PATTERNS.md)
...
- [`NICKNAME_POLICY`](https://mufflyt.github.io/mysterynpi/reference/NICKNAME_POLICY.md)
...
- [`assert_org_name_matches_person_contract()`](https://mufflyt.github.io/mysterynpi/reference/assert_org_name_matches_person_contract.md)
  : Assert that the person/organization name bridge still behaves as
  relied on.
