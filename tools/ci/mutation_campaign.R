...
CATALOGUE <- list(
  ...
  list(id = "graduation-two-three-band-turns-positive",
       file = "R/graduation_year.R",
       find = "log2_lr = c(5.45, 3.35, 0.81, -0.25, -1.37, -1.57, -2.00, -3.16)",
       repl = "log2_lr = c(5.45, 3.35, 0.81, 1.50, 1.50, -1.57, -2.00, -3.16)",
       why  = "the pre-specified sign error returns: a two-to-three-year gap scores as evidence FOR a link when it measures 0.4-0.8 against"),
  list(id = "graduation-bands-become-symmetric",
       file = "R/graduation_year.R",
       find = "log2_lr = c(5.45, 3.35, 0.81, -0.25, -1.37, -1.57, -2.00, -3.16)",
       repl = "log2_lr = c(5.45, 3.35, 3.35, -0.25, -1.37, -1.57, -2.00, -3.16)",
       why  = "graduating a year AFTER credentialing is scored as strongly as a year before, which the measurement says is six times weaker"),
  list(id = "graduation-conflict-veto-removed",
       file = "R/graduation_year.R",
       find = "\"uninformative\", \"conflicts\")",
       repl = "\"uninformative\", \"uninformative\")",
       why  = "a gap beyond ten years stops being reportable at all; the band that is 47.6% of the sensitivity tier goes silent"),
  ...
  list(id = "ablation-fixture-altered",
       file = "tests/testthat/fixtures/ablation/ablation_pins_v1.csv",
       find = "with_table,auto_accept_true,126",
       repl = "with_table,auto_accept_true,127",
