...
see \[parse_npi_search()\], plus the four provenance columns, the two
lineage columns \`found_by_queries\` and \`found_by_edges\`, and the
...
governing matcher SHA, dictionary version, and the modes this run used;
