...
- **Similarity scoring is fenced, not forbidden (2026-09).** The package
  ...
  mutation proves the guard fires), and the scoring dictionary is
  deliberately separate from `NICKNAME_EDGES`, because a table change there
  moves verdicts while a change here moves scores.
